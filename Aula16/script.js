document.getElementById('loginForm').addEventListener('submit', function(e) {
        ...
        if ( !email.value.match(/^[^\s@]+@[^\s@]+\.[^\s@]+$/)) {
            ...
            email.classList.remove('error'); document.getElementById('emailError').classList.remove('show');
        }
        ...
        if (password.value.length < 6) {
            ...
            password.classList.remove('error'); document.getElementById('passwordError').classList.remove('show');
        }
